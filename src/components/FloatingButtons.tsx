...
const FloatingButtons: React.FC = () => {
  const phoneNumber = "+917978933702"; // Replace with your actual number
  const whatsappNumber = "+919437142013"; // Replace with your actual WhatsApp number
  const whatsappMessage = "Hi, I would like to get a quote for vehicle insurance.";
